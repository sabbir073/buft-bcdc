...
export default function Footer() {
  ...
  const membership = [
    { name: "Join BCDC", href: "/membership" },
    { name: "Member Benefits", href: "/membership#benefits" },
    { name: "Registration", href: "/membership#register" },
  ...
  const socialLinks = [
    {
      name: "Facebook",
      href: "https://facebook.com/bcdcbuft",
      icon: (
    ...
    {
      name: "Instagram",
      href: "https://instagram.com/bcdcbuft",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "LinkedIn",
      href: "https://linkedin.com/company/bcdcbuft",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "YouTube",
      href: "https://youtube.com/@bcdcbuft",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/bcdcbuft",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="flex items-center gap-3 text-gray-400">
                ...
                <a href="mailto:bcdc@buft.edu.bd" className="text-sm hover:text-blue-400 transition-colors">
                  bcdc@buft.edu.bd
                </a>
              </div>
              <div className="flex items-center gap-3 text-gray-400">
                ...
                <a href="tel:+8801XXXXXXXXX" className="text-sm hover:text-blue-400 transition-colors">
                  +880 1XXX-XXXXXX
                </a>
              </div>
            </div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  ...
                  >
                    <svg className="w-4 h-4 opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
