  ...
  const contactInfo = [
    {
      ...
      title: "Visit Us",
      content: "BGMEA University of Fashion & Technology, Dhaka, Bangladesh",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Have questions about BCDC? Want to collaborate? We&apos;d love to hear from you.
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                <a
                  href="#"
                  className="w-12 h-12 bg-red-600 rounded-xl flex items-center justify-center text-white hover:bg-red-700 transition-colors"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full py-4 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
              >
                Send Message
